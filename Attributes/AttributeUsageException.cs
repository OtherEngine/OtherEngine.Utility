...
{
	/// <summary> Thrown when an attribute is used incorrectly. </summary>
	public class AttributeUsageException : Exception
	{
		/// <summary> The attribute being validated. </summary>
		public Attribute Attribute { get; private set; }

		/// <summary> The target the attribute is attached to.
		///           May be null if the problem is not regarding a single target. </summary>
